...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="relative z-20 flex w-full max-w-7xl flex-col md:flex-row items-center justify-center space-y-8 md:space-x-8 md:space-y-0">
        {/* TEXT CONTENT */}
        <motion.div
          initial={{ opacity: 0, x: -50 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          className="relative z-10 max-w-3xl w-full text-left px-4 md:px-0 pt-20 md:pt-0"
        >
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center px-4 md:px-0">
          <div className="w-full max-w-sm sm:max-w-md md:max-w-full h-[300px] sm:h-[400px] md:h-[500px]">
            <Hero3DModel />
          </div>
        </div>
      </div>
